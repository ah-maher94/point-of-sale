...
<div class="card card-primary">
    ...
    <form method="POST" action=" {{ route('dashboard.products.store') }} " enctype="multipart/form-data">
        ...
        <div class="card-body">
            ...
            <div class="form-group">
                <img src="{{ asset('uploads/products/default.jpg') }}" class="img-thumbnail profile-img-preview"
                    style="width:100px;">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                <label>Stock</label>
                <input type="number" min="0" step="1" name="stock" class="form-control" value="{{ old('stock') }}">
            </div>
